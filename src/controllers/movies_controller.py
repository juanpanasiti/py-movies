...
from src.data.models.movie_model import MovieModel


class MovieController():

    def list_movies(self):
        if not self.__check_if_movies():
            return
    ...
    def __find_movie(self) -> Optional[MovieModel]:
        self.list_movies()
        option = get_int(
